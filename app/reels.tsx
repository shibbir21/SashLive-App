...
const S = StyleSheet.create({
  ...
  reelGrad: { ...StyleSheet.absoluteFillObject, backgroundColor: 'transparent' },
  ...
  actionCount: { color: '#FFF', fontSize: 12, fontWeight: FontWeight.semibold },
  // Bottom info
  ...
  creatorName: { color: '#FFF', fontSize: FontSize.md, fontWeight: FontWeight.bold },
  ...
  caption: { color: 'rgba(255,255,255,0.9)', fontSize: FontSize.sm, lineHeight: 20 },
